    ...
    this.route.queryParamMap.subscribe(params => {
      if (params.get("instruction")) {
        ...
        if (userAgent.match(/iPad/i) || userAgent.match(/iPhone/i)) {
          // iPad or iPhone 
          this.src="https://firebasestorage.googleapis.com/v0/b/recordingmechanic.appspot.com/o/instruction%2FFile%20from%20iOS.MP4?alt=media&token=c0dcafda-4d33-46e9-8a1d-f4ca6af1d1dd"
        }
        else {
